...
import { LogOut, Settings, Edit as Audit, ChevronDown, User, Fingerprint, CreditCard } from "lucide-react"
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64">
              ...
              <DropdownMenuItem onClick={() => router.push("/auditor/settings")} className="cursor-pointer">
